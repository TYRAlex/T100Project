...
namespace unitycoder_MobilePaint
{
    ...
    public class MobilePaint : MonoBehaviour
    {
        ...
        public bool useBellDrager = true;
        ...
        public int brushSize = 20; // default brush size
        ...
        public void InDragStart(Vector2 pos)
        {
            ...
            if (useLockArea)
            {
                if (!Physics.Raycast(cam.ScreenPointToRay(pos), out hit, Mathf.Infinity, paintLayerMask)) return;
        ...
        public void InDragUpdate(Vector2 pos)
        {
            ...
            //Debug.Log("pos:" + pos + "|input:" + Input.mousePosition);
            if (!Physics.Raycast(cam.ScreenPointToRay(pos), out hit, Mathf.Infinity, paintLayerMask)) { wentOutside = true; return; }
