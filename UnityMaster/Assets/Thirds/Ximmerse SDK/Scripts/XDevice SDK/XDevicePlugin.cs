...
#region Natives
        ...
        internal static class NativeMethods {
            ...
            Debug.LogFormat(" @@ ***** Exit ret {0} ******** ", ret);
...
#region Methods
        ...
        public int sLogger(int level, System.IntPtr tag, System.IntPtr msg)
        {
            switch ((int)level)
            {
                case (int)LOGLevel.LOG_VERBOSE: Log.v(Marshal.PtrToStringAnsi(tag), Marshal.PtrToStringAnsi(msg)); break;
		...
		internal static class NativeMethods {
			...
			public static int XDeviceExit(){
				...
				if(s_XDeviceApi!=null) {
                    ...
                    Debug.LogFormat(" @@ 111 ***** Exit ret {0} ******** ", ret);
					s_XDeviceApi.Dispose();
					s_XDeviceApi=null;
				}
				return ret;
...
#region Methods
		...
		protected static bool s_IsInited=false;
		protected static LogDelegate s_Logger=sLogger;


        [MonoPInvokeCallback(typeof(LogDelegate))]
        public static int sLogger(int level, System.IntPtr tag, System.IntPtr msg)
        {
            switch ((int)level)
            {
                case (int)LOGLevel.LOG_VERBOSE: Log.v(Marshal.PtrToStringAnsi(tag), Marshal.PtrToStringAnsi(msg)); break;
