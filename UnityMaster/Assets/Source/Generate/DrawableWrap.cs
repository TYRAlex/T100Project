...
public class DrawableWrap
{
	...
	{
		L.BeginClass(typeof(Drawable), typeof(UnityEngine.MonoBehaviour));
		...
		L.RegVar("draw_Obj", get_draw_Obj, set_draw_Obj);
		L.RegVar("currentIndex", get_currentIndex, set_currentIndex);
		L.RegVar("showIndex", get_showIndex, set_showIndex);
		L.RegVar("OnDrawableLua", get_OnDrawableLua, set_OnDrawableLua);
		L.EndClass();
	}
	...
	static int ChangeColourAtPoint(IntPtr L)
	{
		try
		{
			...
			Drawable obj = (Drawable)ToLua.CheckObject<Drawable>(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_draw_Obj(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Drawable obj = (Drawable)o;
			UnityEngine.GameObject[] ret = obj.draw_Obj;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index draw_Obj on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_OnDrawableLua(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Drawable obj = (Drawable)o;
			LuaInterface.LuaFunction ret = obj.OnDrawableLua;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index OnDrawableLua on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_draw_Obj(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_OnDrawableLua(IntPtr L)
	{
		object o = null;
