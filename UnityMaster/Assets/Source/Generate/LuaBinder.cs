...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.RegFunction("UnityAction_Ximmerse_InputSystem_ControllerButton", UnityEngine_Events_UnityAction_Ximmerse_InputSystem_ControllerButton);
		L.RegFunction("UnityAction_UnityEngine_Vector3", UnityEngine_Events_UnityAction_UnityEngine_Vector3);
		L.RegFunction("UnityAction_UnityEngine_Vector3_UnityEngine_Vector3_UnityEngine_Vector3", UnityEngine_Events_UnityAction_UnityEngine_Vector3_UnityEngine_Vector3_UnityEngine_Vector3);
		L.EndModule();
	...
	static int UnityEngine_Events_UnityAction_Ximmerse_InputSystem_ControllerButton(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<Ximmerse.InputSystem.ControllerButton>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<Ximmerse.InputSystem.ControllerButton>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	static int UnityEngine_Events_UnityAction_UnityEngine_Vector3_UnityEngine_Vector3_UnityEngine_Vector3(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<UnityEngine.Vector3,UnityEngine.Vector3,UnityEngine.Vector3>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<UnityEngine.Vector3,UnityEngine.Vector3,UnityEngine.Vector3>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
