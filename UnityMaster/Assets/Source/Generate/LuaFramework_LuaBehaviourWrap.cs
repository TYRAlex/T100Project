...
public class LuaFramework_LuaBehaviourWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("autoRelease", get_autoRelease, set_autoRelease);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_autoRelease(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			bool ret = obj.autoRelease;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index autoRelease on a nil value");
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_autoRelease(IntPtr L)
	{
		object o = null;
