...
using bell.ai.t100.remotecontrol;
...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(ObjectClickEffect)),
        _GT(typeof(UIClickEffect)),
        _GT(typeof(RightUICtrl)),
        _GT(typeof(ResourceManager)),
        _GT(typeof(System.Collections.ArrayList)),
        _GT(typeof(Object3DAction)),
        _GT(typeof(Drager)),
        _GT(typeof(Droper)),
        _GT(typeof(DrawableGun)),
        _GT(typeof(BoxCollider2D)),
        _GT(typeof(GunFollow)),
        _GT(typeof(Drawable)),
        _GT(typeof(XDeviceManager)),
        _GT(typeof(GetXDeviceState)),
        _GT(typeof(LogicManager)),
        _GT(typeof(UGUIPointer)),
        _GT(typeof(VectorObject2D)),
        _GT(typeof(VectorLine)),
        _GT(typeof(ModelClick)),
        _GT(typeof(Rigidbody2D)),
        _GT(typeof(PointerEventData)),
        _GT(typeof(PolygonCollider2D)),
        _GT(typeof(ScrollPage)),
        _GT(typeof(BellPaintView)),
        _GT(typeof(XDeviceSupport)),
        _GT(typeof(Collision)),
        _GT(typeof(Collision2D)),
        _GT(typeof(ConnectAndroid)),
        _GT(typeof(FunctionOf3Dof))
    };
