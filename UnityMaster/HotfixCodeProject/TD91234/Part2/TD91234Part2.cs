...
namespace ILFramework.HotClass
{
    ...
    public class TD91234Part2
    {
        ...
        void Start(object o)
        {
            ...
            p2_Level1 = curTrans.Find("part1/Level1");
            p2_Level2 = curTrans.Find("part1/Level2");
            //田丁加载游戏物体方法
            TDLoadGameProperty();
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "c3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(1).GetChild(0).gameObject, "d3", false);
