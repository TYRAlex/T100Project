...
namespace ILFramework.HotClass
{
    ...
    public class TD5634Part1
    {
        ...
        void TDGameInit()
        {
            SetPos(SpinePage.GetRectTransform(),new Vector2(1920,0));
            pageBar.Hide();
            talkIndex = 1;
            curPageIndex = 0;
            isPressBtn = false;
        ...
        private void OnClickBtnBack(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, tem.transform.GetChild(0).name.Substring(0,1) + "2", false, () =>
            {
                SpineManager.instance.DoAnimation(tem, tem.name, false, () =>
                {
                    ...
                    Debug.Log(SpinePage.childCount);
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                ...
                // {
                    ...
                    mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name)+10, null, () =>
                     {
                        //用于标志是否点击过展示板
