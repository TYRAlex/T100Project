...
namespace ILFramework.HotClass
{
    ...
    public class Course7411Part3
    {
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[3] { QuestionType.Multiple, QuestionType.Answer, QuestionType.Answer };

            //添加正确选项
            _answerDic = new Dictionary<int, int[]>();
            _answerDic.Add(0, new int[2] { 0,2 });
            _answerDic.Add(1, null);
            #endregion
