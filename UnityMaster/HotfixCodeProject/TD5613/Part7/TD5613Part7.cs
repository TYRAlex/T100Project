    ...
    public class TD5613Part7
    {
        ...
        void Start(object o)
        {
           ...
           // successSpine.SetActive(false);
            caidaiSpine = curTrans.Find("endingSpine/caidaiSpine").gameObject;
           // caidaiSpine.SetActive(false);


            endingSpine = curTrans.Find("endingSpine");
        ...
        void GameStart()
        {
            ...
            {
                SpineManager.instance.DoAnimation(endingSpine.gameObject, "bd-speak", true);
            },()=>
            {
                SpineManager.instance.DoAnimation(endingSpine.gameObject, "bd-daiji", true);
