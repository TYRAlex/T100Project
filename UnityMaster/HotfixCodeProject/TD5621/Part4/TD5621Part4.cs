...
namespace ILFramework.HotClass
{
    ...
    public class TD5621Part4
    {
        ...
        void GameStart()
        {
            ...
            mask.Show();
            dbd.Show();
            mono.StartCoroutine(SpeckerCoroutine(dbd, SoundManager.SoundType.VOICE, 0, null, null));
            //mono.StartCoroutine(SpeckerCoroutine(dbd, SoundManager.SoundType.COMMONVOICE, 0, null, null));
