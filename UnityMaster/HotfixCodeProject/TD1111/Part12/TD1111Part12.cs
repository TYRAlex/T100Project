		...
		void TalkClick()
		{
			...
			switch (_talkIndex)
			{
				case 1:
					...
					BellSpeck(_sBD, 5, null, () => { _mask.Hide(); _sBD.Hide(); ControllePartInteriorSwitchsShow(); });
					break;
				case 2:
					_smallPartIsFinishs[_smallPartCurIndex] = true;
					BellSpeck(_sBD, 6, null, () => { _mask.Hide(); _sBD.Hide(); ControllePartInteriorSwitchsShow(); });
                    break;				
			}
			_talkIndex++;
		}
			...
			ClickFeedback(go.transform, () => {
				...
				switch (_smallPartCurIndex)
				{
					case 0:     //卡牌2小环节去卡牌1小环节
						ToOthersCardSmallPart(true, 0, 0, 2);
						break;
				}
