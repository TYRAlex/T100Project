	...
	public class TD1111Part9
	{
		...
		void TalkClick()
		{
			...
			switch (_talkIndex)
			{
				case 1:
					...
					BellSpeck(_sBD, 7, null, () => { _mask.Hide(); _sBD.Hide(); ControllePartInteriorSwitchsShow(); });
					break;
				case 2:
					_smallPartIsFinishs[_smallPartCurIndex] = true;
        ...
        private void OnClickLast(GameObject go)
        {
			...
			ClickFeedback(go.transform, () => {
				...
				switch (_smallPartCurIndex)
				{
					case 0:     //卡牌2小环节去卡牌1小环节
						ToOthersCardSmallPart(true, 0, 1, 4);
						break;
				}
