    ...
    public class TD8931Part1
    {
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 11,
                    () =>
                    {
                        mask.SetActive(true);
                        bd.SetActive(true);
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name + "1", false, () =>
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name) + 6, null, () =>
                {
                    //用于标志是否点击过展示板
