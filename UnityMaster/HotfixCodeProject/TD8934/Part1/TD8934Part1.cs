...
namespace ILFramework.HotClass
{
    ...
    public class TD8934Part1
    {
        ...
        void Start(object o)
        {
            ...
            _canClick = true;
            _pageMinIndex = 0;
            _pageMaxIndex = Part1.childCount;
            _moveValue = 1920;
            _duration = 1f;
            _isSlide = false;
            //田丁加载游戏物体方法
        ...
        void MovePart1()
        {
            ...
            L2.gameObject.SetActive(true); R2.gameObject.SetActive(true);
             LRBtnUpdate();
            Part1.GetRectTransform().DOAnchorPosX(-1920, 1f);
            _Mask.GetRectTransform().DOAnchorPosX(22.35f, 1f).OnComplete(() =>
            {
                bd.gameObject.SetActive(true);
                SpineManager.instance.DoAnimation(bd.gameObject, "bd-daiji", true);
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 12, () =>
                {
        ...
        private void GameInit()
        {
            ...
            Part2.GetRectTransform().anchoredPosition = new Vector2(0,0);
        ...
        private void LRBtnUpdate()
        {
            ...
            else if (_curPageIndex == Part1.childCount)
            {
