...
namespace ILFramework.HotClass
{
    ...
    public class TD6724Part1
    {
        ...
        void TDGameInit()
        {
            ...
            SpineShow.transform.localPosition = new Vector3(-960, 540);
            pageBar.transform.GetRectTransform().offsetMax = new Vector2(1920, 0);
            pageBar.transform.GetRectTransform().offsetMin = new Vector2(1920, 0);
        ...
        void TDGameStart()
        {
            ...
            mask.Show();
            bd.Show();
            Talk(bd, 0, null, () => { SoundManager.instance.ShowVoiceBtn(true); });
        }
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 2:
                    ...
                    flag = 0;
                    SpineShow.transform.DOLocalMove(new Vector3(-960 * 3, 540), 1f);
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE,
                    int.Parse(obj.transform.GetChild(0).name) + 3, null, () =>
                    {
                        //用于标志是否点击过展示板
