...
namespace ILFramework.HotClass
{
    ...
    public class TD6714Part2
    {
        ...
        void Start(object o)
        {
            ...
            _part4Tra = curTrans.Find("Parts/4");
        ...
        private void GameInit()
        {
            ...
            _duration = 1.0f; _moveValue = 1920f;
            _isSlide = false;
            _talkIndex = 1;
            SoundManager.instance.ShowVoiceBtn(false);
            SoundManager.instance.SetVoiceBtnEvent(TalkClick);
            _part4Tra.gameObject.Hide();
            AddBtnsEvent(_part4Tra, OnClickArrows);
            ...
            var rect = _part3PagesTra.GetRectTransform();
            SlideSwitchPage(_part3Tra.gameObject,
                () => { LeftSwitchPage(rect, _moveValue, _duration, null, () => {  _isSlide = false; }); },
                () => { RightSwitchPage(rect, -_moveValue, _duration,null, () => { _isSlide = false; }); });
        ...
        void GameStart()
        {
            ...
            BellSpeck(0, () => { _mask.Show(); }, () => {  SoundManager.instance.ShowVoiceBtn(true); });
        }
        ...
        private void OnClickArrows(GameObject go)
        {
            ...
            PlayOnClickSound();
            var name = go.name;
            var spineGo = GetSpineGo(_part4Tra, name + "2");
        ...
        void OnClick1Child(GameObject go)
        {
            ...
            BellSpeck(soundIndex, () => { _mask.Show(); PlaySpine(spineGo, name); },
                () => {
                    _mask.Hide();
                    bool isFinish = 5 == _spine1Names.Count;
                    if (isFinish)
        ...
        {
            BellSpeck(7, null, () => { _mask.Hide(); });
        }

        void TwoOnClickVoice()
        {
            _mask.Show(); _spine1Names.Clear();
            ...
            BellSpeck(6, null, () => {
                ...
                SetMoveAncPosX(_part3PagesTra.GetRectTransform(), -_moveValue, _duration, () => {
                    _mask.Hide();  _part4Tra.gameObject.Show(); InitSpines(_part4Tra,false);                
                });
            });
        }
        ...
        private void RemoveSlideSwitchPageEvent(GameObject rayCastTarget)
        {
            UIEventListener.Get(rayCastTarget).onDown = null;
            UIEventListener.Get(rayCastTarget).onUp = null;
        } 
