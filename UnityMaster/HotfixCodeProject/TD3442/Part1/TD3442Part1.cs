...
namespace ILFramework.HotClass
{
    public class TD3442Part1
    {
        ...
        private void ShowBDAndSpeaker()
        {
            bd.SetActive(true);
            mask.SetActive(true);
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 20, null, () =>
            {
                //mask.SetActive(false);
                //bd.SetActive(false);
                //pageBar.SetActive(true);               
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            {
                isPressBtn = true; 
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name) + 17, null, () =>
                {
