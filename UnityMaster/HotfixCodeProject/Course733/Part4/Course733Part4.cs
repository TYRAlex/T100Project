...
namespace ILFramework.HotClass
{
    ...
    public class Course733Part4
    {
        ...
        private GameObject bell; private GameObject max;
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[3] { QuestionType.Judge,QuestionType.Judge, QuestionType.Multiple };
        ...
        void GameStart()
        {
            //mono.StartCoroutine(SpeckerCoroutine(bell, SoundManager.SoundType.SOUND, 1, null, () =>
            //{
                    ...
                    if (_questionType[_level] != QuestionType.Multiple)
                    {
                        ...
                        else
                        {
                            ...
                            if (_level == 1)
                            {
                                ...
                                { _canClick = true;bell.SetActive(false);
                                    SpineManager.instance.DoAnimation(max, "daiji", true);
                                    max.SetActive(false);
