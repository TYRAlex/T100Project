...
namespace ILFramework.HotClass
{
    ...
    public class TD5644Part2
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "f3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(1).GetChild(0).gameObject, "g3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(2).GetChild(0).gameObject, "h3", false);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    ...
                    _return.gameObject.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 4, null, null));
                    break;
            }
