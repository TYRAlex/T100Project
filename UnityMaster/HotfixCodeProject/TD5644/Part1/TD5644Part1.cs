...
namespace ILFramework.HotClass
{
    ...
    public class TD5644Part1
    {
        ...
        void Start(object o)
        {
            ...
            Part2 = curTrans.Find("Mask/part2");
            _canClick = false;
            ...
            L_1 = curTrans.Find("Mask/part2/Level2/L1");
            L_2 = curTrans.Find("Mask/part2/Level2/L2");
            L_3 = curTrans.Find("Mask/part2/Level2/L3");
            _curPageIndex = 0;
            _pageMinIndex = 0;
            _pageMaxIndex = Part2.childCount - 1;
            _moveValue = 1920;
            _duration = 1f;
            _isSlide = false;
            //田丁加载游戏物体方法
        ...
        void AddDragClickEvent()
        {
            ...
            Util.AddBtnClick(Part2.GetChild(0).GetChild(0).GetChild(1).gameObject, ClickEventLevel2);

            Util.AddBtnClick(Part2.GetChild(1).GetChild(0).GetChild(1).gameObject, ClickEventLevel2);
            Util.AddBtnClick(Part2.GetChild(1).GetChild(1).GetChild(1).gameObject, ClickEventLevel2);
            Util.AddBtnClick(Part2.GetChild(1).GetChild(2).GetChild(1).gameObject, ClickEventLevel2);

            Util.AddBtnClick(Part2.GetChild(2).GetChild(0).GetChild(1).gameObject, ClickEventLevel2);
        }
        ...
        void JudgeClick2(GameObject obj)
        {
            ...
            if (obj.name.Equals("e"))
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 19, null, () =>
                {
                    Mask1.gameObject.Show();
        ...
        private void GameInit()
        {
            ...
            _mask.transform.GetRectTransform().anchoredPosition = new Vector2(1920, 0);
            Part2.GetRectTransform().anchoredPosition = new Vector2(10, 0);
            L2.SetActive(false);R2.SetActive(false);
            _return.gameObject.SetActive(false);
            Mask1.gameObject.SetActive(false);

            Part1.GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            SpineManager.instance.DoAnimation(Part1.GetChild(0).gameObject, "0", false);



            Part2.GetChild(0).GetChild(0).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(1).GetChild(0).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(1).GetChild(1).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(1).GetChild(2).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(2).GetChild(0).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);

            SpineManager.instance.DoAnimation(Part2.GetChild(0).GetChild(0).GetChild(0).gameObject, "a3", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(1).GetChild(0).GetChild(0).gameObject, "b3", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(1).GetChild(1).GetChild(0).gameObject, "c3", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(1).GetChild(2).GetChild(0).gameObject, "d3", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(2).GetChild(0).GetChild(0).gameObject, "e3", false);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 3:
                    ...
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 20, null, () =>
                    {
        ...
        void MovePart1()
        {
           ...
           _mask.GetRectTransform().DOAnchorPosX(6, 1f).OnComplete(() =>
            {
                bd.gameObject.SetActive(true);
        ...
        private void LRBtnUpdate()
        {
            ...
            else if (_curPageIndex == Part2.childCount - 1)
            {
        ...
        void ADDLeftandRightClickEvent()
        {
            ...
            var rect = Part2.GetRectTransform();
