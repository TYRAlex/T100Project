...
namespace ILFramework.HotClass
{
    ...
    public class TD91222Part6
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(part.GetChild(0).GetChild(0).gameObject, "a3", false);
            SpineManager.instance.DoAnimation(part.GetChild(1).GetChild(0).gameObject, "b3", false);
            SpineManager.instance.DoAnimation(part.GetChild(2).GetChild(0).gameObject, "c3", false);
            SpineManager.instance.DoAnimation(part.GetChild(3).GetChild(0).gameObject, "d3", false);
            SpineManager.instance.DoAnimation(part.GetChild(4).GetChild(0).gameObject, "e3", false);
            //田丁初始化
            TDGameInit(); LRBtnUpdate();
        ...
        void AddDragClickEvent()
        {
            ...
            {
                Util.AddBtnClick(part.GetChild(i).GetChild(1).gameObject, ClickEventLevel2);
            }
        }
        ...
        void JudgeClick2(GameObject obj)
        {
            ...
            if (obj.name.Equals("a"))
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.COMMONVOICE, 3, null, () =>
                {
                    Mask1.gameObject.Show();
                    _canPlay = true;
                    _canClick = true;
            ...
            if (obj.name.Equals("b"))
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.COMMONVOICE, 1, null, () =>
                {
        ...
        private void OnClickArrows(GameObject go)
        {
            ...
            if (name == "R")
            {
                SpineManager.instance.DoAnimation(rightBtn.transform.parent.gameObject, name, false);
            }
            if (name == "L")
            {
                SpineManager.instance.DoAnimation(leftBtn.transform.parent.gameObject, name, false);
            }
