...
namespace ILFramework.HotClass
{
    ...
    public class TD91222Part3
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(part.GetChild(0).GetChild(0).gameObject, "d3", false);
            SpineManager.instance.DoAnimation(part.GetChild(1).GetChild(0).gameObject, "e3", false);
            SpineManager.instance.DoAnimation(part.GetChild(2).GetChild(0).gameObject, "f3", false);
            //田丁初始化
            ...
            },()=> 
            {
                ...
                _return.gameObject.SetActive(false);
                SpineManager.instance.DoAnimation(bd.gameObject,"bd-daiji",false);
        ...
        void TDGameStartFunc()
        {
            ...
            bd.SetActive(true);
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.SOUND, 4, ()=> { _return.gameObject.SetActive(true); }, () => { mask.SetActive(false); bd.SetActive(true); }));
        }
