    ...
    public class TD91222Part1
    {
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 2:
                    bd.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd,SoundManager.SoundType.SOUND,9,null,null));
        ...
        void MovePart1()
        {
            ...
            part2.GetRectTransform().DOAnchorPosX(-21f, 1f).OnComplete(()=> {
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 6, () =>
                {
