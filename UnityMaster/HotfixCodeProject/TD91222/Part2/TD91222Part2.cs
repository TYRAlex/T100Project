...
namespace ILFramework.HotClass
{
    ...
    public class TD91222Part2
    {
        ...
        private void GameInit()
        {
            talkIndex = 1;
            //田丁初始化
            mono.StartCoroutine(SpeckerCoroutine(dbd.gameObject,SoundManager.SoundType.SOUND,0,null,()=> 
            {
                mono.StartCoroutine(SpeckerCoroutine(dbd.gameObject, SoundManager.SoundType.SOUND , 1,null,null));
            }));
