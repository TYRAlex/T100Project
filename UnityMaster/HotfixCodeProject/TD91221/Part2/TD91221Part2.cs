...
namespace ILFramework.HotClass
{
    ...
    public class TD91221Part2
    {
        ...
        void Start(object o)
        {
            ...
            R2 = curTrans.Find("R2"); L2 = curTrans.Find("L2");
        ...
        private void GameInit()
        {
            ...
            Part1.transform.GetRectTransform().DOLocalMoveX(0, 0.1f);
            Part2.transform.GetRectTransform().DOLocalMoveX(1920, 0.1f);

            bd.gameObject.SetActive(true);
            L2.gameObject.SetActive(false);
            R2.gameObject.SetActive(false);
            _curPageIndex = 0;
            SpineManager.instance.DoAnimation(Part1.GetChild(0).gameObject, "abcdefgh", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(0).GetChild(0).gameObject, "a", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(1).GetChild(0).gameObject, "b", false);
            SpineManager.instance.DoAnimation(Part2.GetChild(2).GetChild(0).gameObject, "c", false);
        ...
        void TDGameInit()
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,1,()=> { },()=> { SoundManager.instance.ShowVoiceBtn(true); }));
        }
        void TDGameStart()
        {
            SoundManager.instance.PlayClip(SoundManager.SoundType.COMMONBGM, 6, true);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    //田丁游戏开始方法
                    //TDGameStartFunc();
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,0,()=> { _canClick = false; },()=> 
                    { 
                        _canClick = true;
                ...
                case 2:
                    MovePart1();
                    //mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.COMMONVOICE,1,()=> { bd.gameObject.SetActive(true); },()=> { bd.gameObject.SetActive(false); }));
                    break;
                case 3:
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 14, () => { bd.gameObject.SetActive(true); _canClick = false; _return.gameObject.SetActive(true); }, () => {  }));
                    break;
            }
        ...
        void MovePartOpenandClose(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(0).gameObject, obj.name+"2", false, () =>
            {
                ...
                Util.AddBtnClick(Mask1.gameObject, (g) =>
                {
                    ...
                    SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(0).gameObject, obj.name + "4", false, () =>
                    {
        ...
        void ADDLeftandRightClickEvent()
        {
            ...
            SlideSwitchPage(_Mask.gameObject,
                () => { LeftSwitchPage(rect, _moveValue, _duration, () => { _return.gameObject.Show(); }, () => { _return.gameObject.Hide(); LRBtnUpdate(); }); },
                () => { RightSwitchPage(rect, -_moveValue, _duration, () => { _return.gameObject.Show(); }, () => { _return.gameObject.Hide(); LRBtnUpdate(); }); });
        }
        ...
        void MovePart1()
        {
            ...
            {
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 10, () =>
                {
                    bd.gameObject.SetActive(true);
                ...
                }, () =>
                {
                    ...
                    _Mask.GetComponent<Image>().raycastTarget = true;
                    _canClick = true;
                }));
            });
        ...
        private void LRBtnUpdate()
        {
            ...
            else if (_curPageIndex == _pageMaxIndex)
            {
