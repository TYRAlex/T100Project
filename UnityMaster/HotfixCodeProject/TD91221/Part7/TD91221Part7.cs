...
namespace ILFramework.HotClass
{
    ...
    public class TD91221Part7
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part.GetChild(0).GetChild(0).gameObject, "a", true);
            SpineManager.instance.DoAnimation(Part.GetChild(1).GetChild(0).gameObject, "b", true);
            SpineManager.instance.DoAnimation(Part.GetChild(2).GetChild(0).gameObject, "c", true);
            SpineManager.instance.DoAnimation(Part.GetChild(3).GetChild(0).gameObject, "d", true);
            SpineManager.instance.DoAnimation(Part.GetChild(4).GetChild(0).gameObject, "e", true);
            SpineManager.instance.DoAnimation(Part.GetChild(5).GetChild(0).gameObject, "f", true);
            TDGameInit();
            LRBtnUpdate();
