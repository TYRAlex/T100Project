...
namespace ILFramework.HotClass
{
    ...
    public class TD91221Part5
    {
        ...
        private void GameInit()
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(dbd.gameObject,SoundManager.SoundType.SOUND,0,()=> { caidaiSpine.SetActive(true); SpineManager.instance.DoAnimation(caidaiSpine,"sp",false); },()=> 
            {
