...
namespace ILFramework.HotClass
{
    ...
    public class TD91221Part3
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part.GetChild(0).GetChild(0).gameObject, "d", true);
            SpineManager.instance.DoAnimation(Part.GetChild(1).GetChild(0).gameObject, "e", true);
            SpineManager.instance.DoAnimation(Part.GetChild(2).GetChild(0).gameObject, "j", true);
            _return.gameObject.SetActive(false);
            Mask1.gameObject.SetActive(false);

            
            mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 0, ()=> { _return.gameObject.SetActive(true); }, () => { bd.gameObject.SetActive(false); _return.gameObject.SetActive(false); }));
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    //田丁游戏开始方法
                    //  TDGameStartFunc();
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,4,()=> { bd.gameObject.SetActive(true); _canClick = false; _return.gameObject.SetActive(true); },null));
                    break;
            }
        ...
        {
            Debug.Log("adasdasdasdasdasdasdasd");
            if (_canClick)
            {
                Debug.Log("adasdasda");
                SoundManager.instance.ShowVoiceBtn(false);
