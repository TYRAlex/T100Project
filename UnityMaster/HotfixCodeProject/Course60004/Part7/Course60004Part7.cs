...
namespace ILFramework.HotClass
{
    public class Course60004Part7
    {
        ...
        void Start(object o)
        {
            ...
            PowerpointManager.instance.CreatePower(curGo, new string[] { "p1", "p2", "p3", "p4", "p5" });
            lastIndex = -1;
        }
        ...
        {   
            ...
            if (!isPlaying)
            {
                if (PowerpointManager.instance.curIndex < 4 && lastIndex != PowerpointManager.instance.curIndex)
                {
