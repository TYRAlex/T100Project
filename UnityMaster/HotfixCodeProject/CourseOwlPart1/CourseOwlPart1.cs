    ...
    public class CourseOwlPart1
    {
        ...
        void Start(object o)
        {
            ...
            for(int i = 0;i<go.transform.childCount;i++)
            {
                ...
                go.transform.GetChild(i).GetChild(0).GetComponent<Object3DAction>().index = i;
                go.transform.GetChild(i).GetChild(0).GetComponent<Object3DAction>().OnPointUpLua = OnPointerUp;
                if(i == 1)
                {
