...
namespace ILFramework.HotClass
{
    ...
    public class Course735Part3
    {
        ...
        void Start(object o)
        {
            ...
            _mask2 = curTrans.GetGameObject("_mask");
            ...
            _answerDic.Add(0, new int[3] { 1,2,3 });
        ...
        void GameStart()
        {
            ...
            _mask2.SetActive(true);
            mono.StartCoroutine(SpeckerCoroutine(bell,SoundManager.SoundType.SOUND,0,null,()=>
            {
