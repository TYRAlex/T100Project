...
namespace ILFramework.HotClass
{
    ...
    public class TD91241Part2
    {
        ...
        private void GameInit()
        {
            ...
            pageBar.transform.localPosition = new Vector3(0, 0, 0);
            isPlaying = true;
            talkIndex = 1;
            //田丁初始化
            TDGameInit();
        ...
        private void OnClickPlay(GameObject obj)
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.COMMONVOICE, obj.transform.GetSiblingIndex() + 2, null, () =>
            {
                _canClick = true;
