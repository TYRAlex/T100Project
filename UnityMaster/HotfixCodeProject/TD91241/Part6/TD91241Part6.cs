...
namespace ILFramework.HotClass
{
    ...
    public class TD91241Part6
    {
        ...
        private void GameInit()
        {
            ...
            SpinePage.localPosition = new Vector3(0, 0, 0);
            _canClick = true;
            _canMove = true;
            talkIndex = 1;
            //田丁初始化
        ...
        void TDGameInit()
        {
            ...
            for (int i = 0; i < SpinePage.childCount; i++)
            {
                ...
                SpineManager.instance.DoAnimation(SpinePage.GetChild(i).GetChild(0).gameObject, SpinePage.GetChild(i).GetChild(0).name + "3", false);
            }
        ...
        private void OnClickPlay(GameObject obj)
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.COMMONVOICE, obj.transform.GetSiblingIndex() + 1, null, () =>
            {
                _canClick = true;
