...
namespace ILFramework.HotClass
{
    public class Course743Part2
    {
        ...
        void GameInit()
        {
            ...
            //bigJuggle.transform.Find("Background").GetRectTransform().sizeDelta = new Vector2(643, 377);
            bigJuggle.transform.Find("Background").GetRectTransform().sizeDelta = new Vector2(390, 552);
        }
