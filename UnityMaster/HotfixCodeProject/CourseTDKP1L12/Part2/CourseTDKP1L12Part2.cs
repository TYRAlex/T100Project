...
{
    public class CourseTDKP1L12Part2
    {
       GameObject curGo;
        GameObject Npc;
        GameObject Shiled;
        ...
        void Start(object o)
        {
            ...
            PowerpointManager.instance.CreatePower(curGo, new string[] { "1", "2", "3","4","5","6"});
            lastIndex = -1;
        }
        ...
        void Update()
        {
            ...
            {
                Npc.SetActive(false);
                if (PowerpointManager.instance.curIndex > 2 && PowerpointManager.instance.curIndex < 6 && lastIndex != PowerpointManager.instance.curIndex)
                {
