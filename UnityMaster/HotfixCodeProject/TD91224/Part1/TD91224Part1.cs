...
namespace ILFramework.HotClass
{
    ...
    public class TD91224Part1
    {
        ...
        void TDGameStartFunc()
        {
            ...
            flag = 0;
            bd.SetActive(true);
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 0, null, () => { mask.Hide(); bd.Hide(); }));
        }
        ...
        void TDLoadPageBar()
        {
            ...
            leftBtn = curTrans.Find("PageBar/L2/L").gameObject;
            rightBtn = curTrans.Find("PageBar/R2/R").gameObject;
