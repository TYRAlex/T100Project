...
namespace ILFramework.HotClass
{
    public class TD8912Part1
    {
        ...
        private void GameInit()
        {
            ...
            _duration = 0.5f; _moveValue = 1920f;
        ...
        void GameStart()
        {
            ...
            BellSpeck(8, () => { _mask.Show(); }, () => { _mask.Hide(); _bD.Hide(); });
        }
        ...
        void OnClick1Child(GameObject go)
        {
            ...
            BellSpeck(soundIndex, () => { _mask.Show(); PlaySpine(spineGo, name); },
                () => {
                    _mask.Hide();
                    bool isFinish = 8 == _spine1Names.Count;
                    if (isFinish)
