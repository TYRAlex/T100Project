    ...
    public class TD3431Part2
    {
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name) + 13, null, () =>
                {
                    //用于标志是否点击过展示板
        ...
        void TalkClick()
        {
            ...
            if (talkIndex == 3)
            {
                ...
                isPlaying = true;
                bd.SetActive(true);
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 16
                ));
            }
            talkIndex++;
        }
