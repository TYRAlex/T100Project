...
namespace ILFramework.HotClass
{
    ...
    public class Course9211Part4
    {
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[3] { QuestionType.Single, QuestionType.Judge, QuestionType.Judge };
        ...
        IEnumerator waitTime(float time,Action method_1) 
        {
