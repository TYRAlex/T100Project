...
namespace ILFramework.HotClass
{
    ...
    public class TD6731Part1
    {
        ...
        private void GameInit()
        {
            ...
            Part2.GetChild(0).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(1).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(2).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part2.GetChild(3).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            ...
            SpineManager.instance.DoAnimation(Part2.GetChild(3).GetChild(0).gameObject, "d3", false);
            //狮子王好听吗
            bd.SetActive(true);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 3:
                    ...
                    bd.gameObject.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 14, null, () =>
                    {
        ...
        void MovePart1()
        {
            ...
            {
                R2.GetChild(0).gameObject.GetComponent<Empty4Raycast>().raycastTarget = true;
                bd.gameObject.SetActive(true);
               
                SpineManager.instance.DoAnimation(bd.gameObject, "bd-daiji", true);
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 9, () =>
                {
