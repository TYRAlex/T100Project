...
namespace ILFramework.HotClass
{
    ...
    public class TD6731Part2
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "e3", true);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    ...
                    bd.gameObject.SetActive(true);
                    _return.gameObject.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND, 2, null, null));
                    break;
