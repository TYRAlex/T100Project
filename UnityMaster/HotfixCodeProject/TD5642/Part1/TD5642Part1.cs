...
namespace ILFramework.HotClass
{
    ...
    public class TD5642Part1
    {
        ...
        void MovePart1()
        {
            ...
            Part2.GetRectTransform().DOAnchorPosX(-9, 1f).OnComplete(() =>
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.SOUND,11, () =>
                {
                    _Mask.GetComponent<Image>().raycastTarget = true;
