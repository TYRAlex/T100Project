...
namespace ILFramework.HotClass
{
    ...
    public class TD5642Part3
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "g3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(1).GetChild(0).gameObject, "h3", false);
