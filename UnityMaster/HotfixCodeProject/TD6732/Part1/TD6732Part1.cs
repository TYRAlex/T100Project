...
namespace ILFramework.HotClass
{
    ...
    public class TD6732Part1
    {
        ...
        void TDGameInit()
        {
            ...
            {
                SpinePage.GetChild(i).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
                SpineManager.instance.DoAnimation(SpinePage.GetChild(i).GetChild(0).gameObject, SpinePage.GetChild(i).GetChild(0).GetChild(0).name+"3", false);
            }
        ...
        private void OnClickBtnBack(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, tem.transform.GetChild(0).name + "2", false, () =>
            {
                ...
                if (temp == (Mathf.Pow(2, tem.transform.parent.parent.childCount) - 1))
                {
                    SoundManager.instance.ShowVoiceBtn(true);
                }
