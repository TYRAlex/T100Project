...
namespace ILFramework.HotClass
{
    ...
    public class Course924Part3
    {
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[3] { QuestionType.Single, QuestionType.Multiple, QuestionType.Multiple };

            //添加正确选项
            _answerDic = new Dictionary<int, int[]>();
            _answerDic.Add(0, new int[1] { 3 });
            _answerDic.Add(1, new int[4] { 0,1, 2, 3 });
            _answerDic.Add(2, new int[2] { 1, 2 });
            #endregion
