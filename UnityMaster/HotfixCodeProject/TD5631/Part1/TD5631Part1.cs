...
namespace ILFramework.HotClass
{
    ...
    public class TD5631Part1
    {
        ...
        {
            if (curPageIndex >= SpinePage.childCount - 1 || isPlaying || isPressBtn || isEnd)
                return;
            isPressBtn = true;
            BtnPlaySound();
            ...
            SpineManager.instance.DoAnimation(tem, obj.name + "1", false, () =>
              {
                  ...
                  mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name) + 15, null, () =>
                  {
                    //用于标志是否点击过展示板
        ...
        private void GameInit()
        {
            ...
            leftBtn.transform.parent.GetRectTransform().anchoredPosition = new Vector2(1920, 0);
            rightBtn.transform.parent.GetRectTransform().anchoredPosition = new Vector2(1920, 0);
            SpinePage.GetRectTransform().anchoredPosition = new Vector2(1940, -20);
        ...
        void TalkClick()
        {
            ...
            if (talkIndex == 2)
            {
                bd.SetActive(true);
                isPlaying = true;
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 14, null, () =>
                {
                    isPlaying = false;
                    flag = 0;
                    bd.SetActive(false);
                    ...
                    leftBtn.transform.parent.GetRectTransform().DOAnchorPosX(0, 1);
                    rightBtn.transform.parent.GetRectTransform().DOAnchorPosX(0, 1);
            ...
            if (talkIndex == 3)
            {
                ...
                isPlaying = true;
                bd.SetActive(true);
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 17
                ));
            }
            talkIndex++;
        }
