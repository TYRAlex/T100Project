...
namespace ILFramework.HotClass
{
    ...
    public class TD5631Part2
    {
        ...
        private void GameInit()
        {
            ...
            isPressBtn = false;
            flag = 0;
            SpinePage.GetRectTransform().anchoredPosition = new Vector2(20, -20);
        ...
        void GameStart()
        {
            ...
            bd.SetActive(true);
            isPlaying = true;
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 0, null, () => { bd.SetActive(false); isPlaying = false; }));
        }
        /// <summary>
        /// bell说话协程
        /// </summary>
        ...
        void TalkClick()
        {
            ...
            if (talkIndex == 1)
            {
                ...
                bd.SetActive(true);
                isPlaying = true;
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 3, null, () => { }));
            }
            talkIndex++;
        }
