    ...
    public class TD3432Part2
    {
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 2:
                    flag = 0;
                    mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 12,
                    () =>
                    {
                        mask.SetActive(true);
                        bd.SetActive(true);
        ...
        void TDLoadPageBar()
        {
            ...
            leftBtn = pageBar.transform.Find("L2/L").gameObject;
            rightBtn = pageBar.transform.Find("R2/R").gameObject;
