...
namespace ILFramework.HotClass
{
    ...
    public class Course745Part4
    {
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[3] { QuestionType.Multiple, QuestionType.Single,QuestionType.Answer};

            //添加正确选项
            _answerDic = new Dictionary<int, int[]>();
            _answerDic.Add(0, new int[3] { 0,1,3 });
