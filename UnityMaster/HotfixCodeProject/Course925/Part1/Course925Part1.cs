...
namespace ILFramework.HotClass
{
    public class Course925Part1
    {
        ...
        private void OnClicks(GameObject go)
        {
            ...
            Delay(1, () => { PlayVoice(voiceIndex); });  

            PlaySequenceSpine(_jingSpine, new List<string> { name,spineName}, Back);
            Delay(1.0f, () => { PlaySound(soundIndex);});
