...
namespace ILFramework.HotClass
{
    ...
    public class TD6721Part6
    {
        ...
        private Transform Lv3;
        private Transform Lv4;
        private Transform Lv5;
        private Transform Lv6;
        private Transform Lv7;
        private Transform Lv8;
        private Transform Lv9;

        private Transform Lv1a;
        private Transform Lv2b;
        private Transform Lv2c;
        private Transform Lv2d;
        private Transform Lv3e;
        private Transform Lv3f;
        private Transform Lv4g;
        private Transform Lv4h;
        private Transform Lv5i;
        private Transform Lv5j;
        private Transform Lv6l;
        private Transform Lv6m;
        private Transform Lv8o;
        private Transform Lv9p;

        private Transform spine1;
        private Transform spine2;
        private Transform spine3;
        private Transform spine4;
        private Transform spine5;
        private Transform spine6;
        private Transform spine7;
        private Transform spine8;
        private Transform spine9;
        private Transform spine10;
        private Transform spine11;
        private Transform spine12;
        private Transform spine13;
        private Transform spine14;
        private Transform spine15;
        ...
        void Start(object o)
        {
            ...
            curPageIndex = 0;
            _pageMinIndex = 0;
            _pageMaxIndex = part.childCount - 1;
            _moveValue = 1920;
            _duration = 1f;

            Lv1 = curTrans.Find("Mask/part/Level1");
            Lv2 = curTrans.Find("Mask/part/Level2");
            Lv3 = curTrans.Find("Mask/part/Level3");
            Lv4 = curTrans.Find("Mask/part/Level4");
            Lv5 = curTrans.Find("Mask/part/Level5");
            Lv6 = curTrans.Find("Mask/part/Level6");
            Lv7 = curTrans.Find("Mask/part/Level7");
            Lv8 = curTrans.Find("Mask/part/Level8");
            Lv9 = curTrans.Find("Mask/part/Level9");
            Lv1a = curTrans.Find("Mask/part/Level1/a");
            Lv2b = curTrans.Find("Mask/part/Level2/b");
            Lv2c = curTrans.Find("Mask/part/Level2/c");
            Lv2d = curTrans.Find("Mask/part/Level2/d");
            Lv3e = curTrans.Find("Mask/part/Level3/e");
            Lv3f = curTrans.Find("Mask/part/Level3/f");
            Lv4g = curTrans.Find("Mask/part/Level4/g"); Lv4h = curTrans.Find("Mask/part/Level4/h");
            Lv5i = curTrans.Find("Mask/part/Level5/i"); Lv5j = curTrans.Find("Mask/part/Level5/j");
            Lv6l = curTrans.Find("Mask/part/Level6/l"); Lv6m= curTrans.Find("Mask/part/Level6/m");
            Lv8o = curTrans.Find("Mask/part/Level8/o"); Lv9p = curTrans.Find("Mask/part/Level9/p");

            spine1 = curTrans.Find("Mask/part/Level1/spine1");
            spine2= curTrans.Find("Mask/part/Level2/spine1");
            spine3 = curTrans.Find("Mask/part/Level2/spine2");
            spine4 = curTrans.Find("Mask/part/Level2/spine3");
            spine5 = curTrans.Find("Mask/part/Level3/spine1");
            spine6 = curTrans.Find("Mask/part/Level3/spine2");
            spine7 = curTrans.Find("Mask/part/Level4/spine1");
            spine8 = curTrans.Find("Mask/part/Level4/spine2");
            spine9 = curTrans.Find("Mask/part/Level5/spine1");
            spine10 = curTrans.Find("Mask/part/Level5/spine2");
            spine11 = curTrans.Find("Mask/part/Level6/spine1");
            spine12 = curTrans.Find("Mask/part/Level6/spine2");
         
            spine14 = curTrans.Find("Mask/part/Level8/spine1");
            spine15 = curTrans.Find("Mask/part/Level9/spine1");
            _canClick = true;
            _isSlide = false;
            //田丁加载游戏物体方法
            TDLoadGameProperty();
        ...
        private void GameInit()
        {
            ...
            part.transform.GetRectTransform().DOLocalMoveX(0,0.1f);
           
            SpineManager.instance.DoAnimation(spine1.gameObject,"a3",true);

            SpineManager.instance.DoAnimation(spine2.gameObject, "b3", true);
            SpineManager.instance.DoAnimation(spine3.gameObject, "c3", true);
            SpineManager.instance.DoAnimation(spine4.gameObject, "d3", true);

            SpineManager.instance.DoAnimation(spine5.gameObject, "e3", true);
            SpineManager.instance.DoAnimation(spine6.gameObject, "f3", true);

            SpineManager.instance.DoAnimation(spine7.gameObject, "g3", true);
            SpineManager.instance.DoAnimation(spine8.gameObject, "h3", true);

            SpineManager.instance.DoAnimation(spine9.gameObject, "i3", true);
            SpineManager.instance.DoAnimation(spine10.gameObject, "j3", true);

            SpineManager.instance.DoAnimation(spine11.gameObject, "l3", true);
            SpineManager.instance.DoAnimation(spine12.gameObject, "m3", true);

          //  SpineManager.instance.DoAnimation(spine13.gameObject, "n3", true);
            SpineManager.instance.DoAnimation(spine14.gameObject, "o3", true);
            SpineManager.instance.DoAnimation(spine15.gameObject, "p3", true);
            //田丁初始化
            TDGameInit();
            LRBtnUpdate();
        }
        ...
        {
            Util.AddBtnClick(Lv1a.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv2b.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv2c.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv2d.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv3e.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv3f.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv4g.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv4h.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv5i.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv5j.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv6l.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv6m.gameObject, ClickCommonEvent);
        
            Util.AddBtnClick(Lv8o.gameObject, ClickCommonEvent);
            Util.AddBtnClick(Lv9p.gameObject, ClickCommonEvent);
        }
        private void ClickCommonEvent(GameObject obj) 
        {
            Debug.Log("4399");
            Debug.Log(_canClick);
            if (_canClick)
            {
                ...
                if (obj.name == "a")
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine1.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine1.gameObject, obj.name, false, () =>
                    {
               ...
               else if (obj.name == "b")
                {
                    ...
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine2.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                ...
                else if (obj.name == "c")
                {
                    ...
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine3.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine4.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine4.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine4.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine5.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine5.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine5.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine6.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine6.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine6.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine7.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine7.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine7.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine8.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine8.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine8.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine9.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine9.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine9.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine10.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine10.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine10.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine11.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine11.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine11.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine12.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine12.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine12.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine13.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine13.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine13.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine14.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine14.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine14.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    // obj.transform.parent.GetChild(0).SetAsLastSibling();
                    spine15.SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(spine15.gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(spine15.gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
        ...
        private void ClickEventLevel2(GameObject obj)
        {
            if (_canClick)
            {
                ...
                {
                  //  obj.transform.parent.GetChild(1).SetAsLastSibling();
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(1).gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(1).gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
                ...
                {
                    _return.gameObject.SetActive(true);
                    SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(2).gameObject, obj.name, false, () =>
                    {
                        Mask1.gameObject.SetActive(true);
                        Util.AddBtnClick(Mask1.gameObject, (g) =>
                        {
                            Mask1.gameObject.Hide();
                            //   SoundManager.instance.ShowVoiceBtn(true);//播放close
                            SpineManager.instance.DoAnimation(obj.transform.parent.GetChild(2).gameObject, obj.name + "2", false, () =>
                            {
                                _return.gameObject.Hide();
                                _canClick = true;
                            });
        ...
        private void ClickEventLevel9(GameObject obj)
        {
            if (_canClick)
            {
                SoundManager.instance.ShowVoiceBtn(false);
        ...
        void ADDLeftandRightClickEvent()
        {
            ...
            var rect = part.GetRectTransform();
            SlideSwitchPage(_Mask.gameObject,
                () => { LeftSwitchPage(rect, _moveValue, _duration, () => { _return.gameObject.Show(); }, () => { _return.gameObject.Hide(); _isSlide = false; LRBtnUpdate(); }); },
                () => { RightSwitchPage(rect, -_moveValue, _duration, () => { _return.gameObject.Show(); }, () => { _return.gameObject.Hide(); _isSlide = false; LRBtnUpdate(); }); });
        }
        ...
        private void LRBtnUpdate()
        {
            ...
            else if (_curPageIndex == part.childCount - 1)
            {
