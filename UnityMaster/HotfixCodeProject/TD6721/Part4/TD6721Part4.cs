...
namespace ILFramework.HotClass
{
    ...
    public class TD6721Part4
    {
        ...
        {
            talkIndex = 1;
            caidaiSpine.gameObject.SetActive(true);
            SpineManager.instance.DoAnimation(caidaiSpine.gameObject,"sp",false);
            SoundManager.instance.PlayClip(SoundManager.SoundType.COMMONBGM,4,true);
            mono.StartCoroutine(SpeckerCoroutine(dbd.gameObject,SoundManager.SoundType.SOUND,0,null,null));
            //田丁初始化
            TDGameInit();
        }
