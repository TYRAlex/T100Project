...
namespace ILFramework.HotClass
{
    ...
    public class TD6721Part1
    {
        ...
        private void GameInit()
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,0,null,()=> { SoundManager.instance.ShowVoiceBtn(true);  }));
        ...
        void TalkClick()
        {
            ...
            {
                case 1:
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,1,null,()=> { _canClick = true; }));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    bd.gameObject.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND,13,()=> 
                    {
