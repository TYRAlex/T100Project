...
namespace ILFramework.HotClass
{
    ...
    {    
        ...
        void Init()
        {
            ...
            {
                PlayAnimationState(winSpine[i].GetComponent<SkeletonGraphic>(), finishSpine[(int)FINISH_SPINE.Light]);
            }            
        ...
        void StarScene(GameObject btn)
        {
            ...
            {
                Drager drager = polyDrag[i].GetComponent<Drager>();
        ...
        void EndDrag(Vector3 pos, int type, int index, bool isEnd)
        {
            ...
            Debug.LogError(glassList.Count + ":" + polyDrag[index]);
