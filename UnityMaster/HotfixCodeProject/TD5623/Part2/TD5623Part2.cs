...
namespace ILFramework.HotClass
{
    public class TD5623Part2
    {
        ...
        void TalkClick()
        {
            ...
            {
                case 1:
                    BellSpeck(_bD, 0, null, () => { _mask.Hide(); _bD.Hide(); SoundManager.instance.ShowVoiceBtn(true); });
                    break;
                case 2:
                    _mask.Show();
                    ...
                    BellSpeck(_bD, 12, null,
                        () => {
                            SetMoveAncPosX(_part1Tra.GetRectTransform(), -_moveValue, _duration);
                            SetMoveAncPosX(_part2PagesTra.GetRectTransform(), -_moveValue, _duration);
                            Delay(_duration, () => { _mask.Hide(); });
                            _bD.Hide();
                        });
                    break;
                case 3:
                    _bD.Show(); _mask.Show();
                    BellSpeck(_bD, 13,null,()=> {
                        _isOnClickOnce = true;
                        _bD.Hide(); _mask.Hide();
                    });
                    break;
        ...
        void OnClickMaterials(GameObject go)
        {
            ...
            BellSpeck(_bD, soundIndex,
                () => {
                    _mask.Show(); PlaySpine(spineGo, name);
                },
                () => {
                    _mask.Hide();
        ...
        private void OnClickCard(GameObject go)
        {
            ...
            void OnClickMask(GameObject g)
            {
                ...
                PlaySpine(spineGo, spineName2, () => {
                    _mask.Hide();
                    if (_recordOnClickNames.Count == _recordOnClickNums &&!_isOnClickOnce)
                        SoundManager.instance.ShowVoiceBtn(true);
                });
            }
        }
