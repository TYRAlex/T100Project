...
namespace ILFramework.HotClass
{
    public class TD5623Part6
    {
        ...
        void GameInit()
        {
            ...
            InitSpines(_spines, false);
            AddEvents(_spines, OnClickCard);
        ...
        {
            PlayCommonBgm(6);
            BellSpeck(_bD, 4,()=> { _mask.Show(); },()=> { _mask.Hide(); _bD.Hide(); });
        }
        ...
        void TalkClick()
        {
            ...
            switch (_talkIndex)
            {
                case 1:
                    _mask.Show(); _bD.Show();
                    BellSpeck(_bD, 3,null,()=> { _isOnClickOnce = true; _mask.Hide(); _bD.Hide(); });
                    break;
