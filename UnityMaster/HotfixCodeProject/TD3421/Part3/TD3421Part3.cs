...
namespace ILFramework.HotClass
{
    ...
    public class TD3421Part3
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(spine1.gameObject,"b1",false);
            SpineManager.instance.DoAnimation(spine2.gameObject, "c1", false);
            SpineManager.instance.DoAnimation(spine3.gameObject, "d1", false);
        ...
        void TalkClick()
        {
            ...
            //    devil.SetActive(false);
            //    bd.SetActive(false);
            //   // mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.COMMONVOICE, 1, null, () => { mask.SetActive(false); bd.SetActive(false); }));
            //}
            if (talkIndex == 1) 
            {
