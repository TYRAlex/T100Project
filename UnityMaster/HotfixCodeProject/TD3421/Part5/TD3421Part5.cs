...
namespace ILFramework.HotClass
{
    ...
    public class TD3421Part5
    {
        ...
        private void GameInit()
        {
            ...
            SoundManager.instance.PlayClip(SoundManager.SoundType.COMMONBGM, 4, true);//背景音乐
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.SOUND, 0, ()=>
            {
                ...
                SpineManager.instance.DoAnimation(dbd, "bd-speak", true);

            }, ()=> 
            {
                SpineManager.instance.DoAnimation(dbd, "bd-daiji", true);
