        ...
        void TalkClick()
        {
            ...
            switch (_talkIndex)
            {
                case 1:
                    ...
                    BellSpeck(_bD, 14, null,
                        () => {
                            SetMoveAncPosX(_part1Tra.GetRectTransform(), -_moveValue, _duration);
                            SetMoveAncPosX(_part2PagesTra.GetRectTransform(), -_moveValue, _duration, () => { _mask.Hide(); });
                            _bD.Hide(); _isPlaying = false;
                        });
                    break;
                case 2:
