    ...
    public class TD8944Part1
    {
        ...
        void TDGameStartFunc()
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 5, null, () =>
            {
                ...
                curPageIndex = -1;
                SpineShow.DOMoveX(-1920, 1).OnComplete(() => {
                    lBtn.SetActive(true);
                    rBtn.SetActive(true);
        ...
        private void LRBtnUpdate()
        {
            ...
            else if (curPageIndex == SpinePage.childCount - 3)
            {
        ...
        private void SlideSwitchPage(GameObject rayCastTarget)
        {
            ...
            UIEventListener.Get(rayCastTarget).onUp = upData =>
            {
                ...
                if (dis > 300)
                {
                    ...
                    {
                        if (curPageIndex >= SpinePage.childCount - 3 || isPlaying)
                            return;
                        SetMoveAncPosX(-1);
                    }
                }
