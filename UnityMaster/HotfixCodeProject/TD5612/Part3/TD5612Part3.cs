    ...
    public class TD5612Part3
    {
        ...
        private void OnClickBtnRight(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(obj.transform.parent.gameObject, obj.name, false, () => {
                SetMoveAncPosX(-1); isPressBtn = false;
            });
        }
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                SpineManager.instance.DoAnimation(obj.transform.parent.gameObject, obj.name + "3", false, () =>
                {
                    ...
                    mono.StartCoroutine(SpeckerCoroutine(SoundManager.SoundType.VOICE, obj.transform.parent.GetSiblingIndex() + 2, null, () =>
                    {
                        isPressBtn = false;
                    }));
                });
        ...
        {           
            ...
            mono.StartCoroutine(SpeckerCoroutine(SoundManager.SoundType.VOICE, 0, null, () => { isPressBtn = false; isPlaying = false; bd.SetActive(false); SoundManager.instance.ShowVoiceBtn(true); }));
        }
        /// <summary>
        /// bell说话协程
        /// </summary>
        ...
        void TalkClick()
        {
            ...
            if (talkIndex == 1)
            {
                ...
                {
                    bd.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(SoundManager.SoundType.VOICE, 1, null, () => { bd.SetActive(false); isPlaying = false; isPressBtn = false; }));
                }
                else
                {
                    SetMoveAncPosX(-1, 1, () =>
