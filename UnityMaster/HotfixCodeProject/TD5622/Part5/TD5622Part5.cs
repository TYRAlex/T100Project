...
namespace ILFramework.HotClass
{
    ...
    public class TD5622Part5
    {
        ...
        void Start(object o)
        {
            ...
            mask.SetActive(true);
            curTrans.Find("mask/caidaiSpine").gameObject.SetActive(true);
            SpineManager.instance.DoAnimation(curTrans.Find("mask/caidaiSpine").gameObject, "sp", false);
            TDBeginFunc();
        ...
        void TDBeginFunc()
        {
            ...
            mono.StartCoroutine(SpeckerCoroutine(dbd, SoundManager.SoundType.VOICE, 0, null, 
                ()=>
                {
                    //mono.StartCoroutine(SpeckerCoroutine(dbd, SoundManager.SoundType.COMMONVOICE, 7, null, null));
                }
                ));
        }
