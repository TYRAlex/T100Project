        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                ...
                // {
                    ...
                    mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name), null, () =>
                     {
                        //用于标志是否点击过展示板
                        if ((flag & (1 << obj.transform.GetSiblingIndex())) == 0)
                        {
