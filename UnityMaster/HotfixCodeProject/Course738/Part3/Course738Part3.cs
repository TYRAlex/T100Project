...
namespace ILFramework.HotClass
{
    ...
    public class Course738Part3
    {
        ...
        void Start(object o)
        {
            ...
            #region 需要进行修改的部分
            //添加选择题类型
            _questionType = new QuestionType[2] { QuestionType.Single, QuestionType.Single};
        ...
        //bell说话
        private void talk(int i) 
        {
            _canClickBtn = false;
            _canClickChoose = false;
            _canClickSure = false;
            bell.SetActive(true);
            mono.StartCoroutine(SpeckerCoroutine(bell, SoundManager.SoundType.SOUND, i, null, () =>
            {
