...
namespace ILFramework.HotClass
{
    ...
    public class TD3434Part6
    {
        ...
        private void GameInit()
        {
            ...
            Part1.transform.GetRectTransform().anchoredPosition = new Vector3(0, 0, 0);

            Part1.GetChild(0).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part1.GetChild(1).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part1.GetChild(2).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part1.GetChild(3).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part1.GetChild(4).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
            Part1.GetChild(5).GetChild(0).gameObject.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);

            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "a3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(1).GetChild(0).gameObject, "b3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(2).GetChild(0).gameObject, "c3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(3).GetChild(0).gameObject, "d3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(4).GetChild(0).gameObject, "e3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(5).GetChild(0).gameObject, "f3", false);
            //田丁初始化
            TDGameInit();
        }
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    ...
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.COMMONVOICE, 0, null, null));
                    break;
            }
        ...
        void AddDragClickEvent()
        {
            for (int i = 0; i < Part1.childCount; i++)
            {
                ...
                Util.AddBtnClick(Part1.GetChild(i).GetChild(1).gameObject, ClickEventLevel1);
            }
        ...
        void JudgeClick2(GameObject obj)
        {
            ...
            if (obj.name.Equals("f"))
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd.gameObject, SoundManager.SoundType.COMMONVOICE, 0, null, () =>
                {
                    Mask1.gameObject.Show();
