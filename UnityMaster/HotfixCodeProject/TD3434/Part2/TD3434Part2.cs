...
namespace ILFramework.HotClass
{
    ...
    public class TD3434Part2
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(Part1.GetChild(0).GetChild(0).gameObject, "d3", false);
            SpineManager.instance.DoAnimation(Part1.GetChild(1).GetChild(0).gameObject, "e3", false);
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                case 1:
                    ...
                    _return.gameObject.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd.gameObject,SoundManager.SoundType.SOUND, 3, null,null));
                    break;
            }
