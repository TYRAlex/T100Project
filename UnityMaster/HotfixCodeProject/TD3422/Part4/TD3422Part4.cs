...
namespace ILFramework.HotClass
{
    ...
    public class TD3422Part4
    {
        ...
        private void GameInit()
        {
            ...
            SpineManager.instance.DoAnimation(SpinePage.GetChild(0).gameObject, "kong", false, 
            ()=> 
            {
                SpineManager.instance.DoAnimation(SpinePage.GetChild(0).gameObject, SpinePage.GetChild(0).name + "3", false);
            });
        }
