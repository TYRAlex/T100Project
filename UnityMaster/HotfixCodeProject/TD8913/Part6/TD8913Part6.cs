...
namespace ILFramework.HotClass
{
    ...
    public class TD8913Part6
    {
        ...
        void GameStart()
        {
            //float timer= SoundManager.instance.PlayClip(SoundManager.SoundType.COMMONSOUND, 0, false);
            isPlaying = false;
            // mono.StartCoroutine(WaitTimeAndExcuteNext(timer, () =>
            // {
            //     isPlaying = false;
            // }));
        }
