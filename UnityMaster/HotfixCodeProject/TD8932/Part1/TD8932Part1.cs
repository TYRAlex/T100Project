    ...
    public class TD8932Part1
    {
        ...
        void TDGameInit()
        {
            ...
            for (int i = 0; i < SpinePage.childCount; i++)
            {
                ...
                SpineManager.instance.DoAnimation(SpinePage.GetChild(i).GetChild(0).gameObject, SpinePage.GetChild(i).name+"3", false);
            }
        ...
        void TalkClick()
        {
            ...
            switch (talkIndex)
            {
                ...
                case 3:
                    mask.SetActive(true);
                    bd.SetActive(true);
                    mono.StartCoroutine(SpeckerCoroutine(bd,SoundManager.SoundType.VOICE,15));
        ...
        private void OnClickBtnBack(GameObject obj)
        {
            ...
            {
                obj.SetActive(false); _canClick = true;_canMove = true;_jugle[Convert.ToInt32(tem.transform.GetChild(0).GetChild(0).gameObject.name)] = true; Jugle();
            });
        }
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            {
                mono.StartCoroutine(SpeckerCoroutine(bd,SoundManager.SoundType.VOICE,Convert.ToInt32(obj.transform.GetChild(0).gameObject.name)+10,null,
                    ()=>
                    {
