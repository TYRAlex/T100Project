...
namespace ILFramework.HotClass
{
    ...
    public class TD8932Part4
    {
        ...
        {
            caidaiSpine.GetComponent<Spine.Unity.SkeletonGraphic>().Initialize(true);
        ...
        private void playSuccessSpine(Action ac = null)
        {
            ...
            SoundManager.instance.PlayClip(SoundManager.SoundType.COMMONBGM, 4, false);
