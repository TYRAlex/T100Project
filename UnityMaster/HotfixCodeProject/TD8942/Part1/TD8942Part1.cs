    ...
    public class TD8942Part1
    {
        ...
        private void OnClickShow(GameObject obj)
        {
            ...
            SpineManager.instance.DoAnimation(tem, obj.name, false, () =>
            {
                ...
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, int.Parse(obj.transform.GetChild(0).name) + 12, null, () =>
                {
                    //用于标志是否点击过展示板
        ...
        void TalkClick()
        {
            ...
            if (talkIndex == 2)
            {
                bd.SetActive(true);
                isPlaying = true;
                mono.StartCoroutine(SpeckerCoroutine(bd, SoundManager.SoundType.VOICE, 11, null, () =>
                {
                    isPlaying = false;
                    flag = 0;
                    bd.SetActive(false);
